        ...
        //  - Sum the age of people who have lass than 5 candies
            ...
            for (Map<String, Object> entry:map){
                if ((int)entry.get("candies")> 4){
                    names = names + entry.get("name");
                    names = names + " ";
                }
            }
            System.out.println("Kids who have got more candies, than 4: " + names);

            Integer sumOfAgeInteger = 0;
            ...
            for (Map<String, Object> entry:map){
                if ((int)entry.get("candies")< 5){
                    if (entry.get("age")instanceof Double){
                        sumOfAgeDouble = sumOfAgeDouble + (Double)entry.get("age");
                    }
                    if (entry.get("age")instanceof Integer){
                        sumOfAgeInteger = sumOfAgeInteger + (Integer)entry.get("age");
                    }
                }
            }
                finalAge = sumOfAgeDouble + sumOfAgeInteger;
